...
if version < 600
    " same as SpecialKey
    highlight NonText   guibg=bg guifg=#444444
else
    " Bottom fill (use e.g. same as LineNr)
    highlight NonText   gui=None guibg=bg guifg=#444444
endif
highlight Normal        gui=None guibg=#222222 guifg=honeydew2
highlight Question      gui=bold  guifg=SeaGreen2 guibg=bg
highlight Search        gui=NONE guibg=Black guifg=NONE
...
highlight Todo          guifg=#B5A798 guibg=bg
