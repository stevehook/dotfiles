...
command LustyJugglerLeft :call <SID>LustyJugglerKeyPressed('left')
...
class LustyJuggler
  ...
  public
    ...
    def run
      ...
      map_key("h",  ":call <SID>LustyJugglerKeyPressed('Left')<CR>")
      map_key("l", ":call <SID>LustyJugglerKeyPressed('Right')<CR>")
